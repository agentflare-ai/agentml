...
The Memory namespace (`github.com/agentflare-ai/agentml/memory`) provides persistent storage, vector embeddings, similarity search, and graph database capabilities powered by `sqlite-graph` - all in a single SQLite file.
