...
<agentml xmlns="github.com/agentflare-ai/agentml"
  ...
  <state id="generate_with_memory">
    <onentry>
      <!-- Search memory for relevant context -->
      <memory:search location="context" expr="queryEmbedding" limit="5" />

      <!-- Generate response using context -->
      <openai:generate
        model="gpt-4o"
        location="_event"
        promptexpr="'Based on this context: ' + JSON.stringify(context) + ' answer: ' + userQuery" />
    </onentry>
  ...
  <state id="store_response">
    <onentry>
      ...
      <memory:embed location="responseEmbedding" expr="response" />
    </onentry>
