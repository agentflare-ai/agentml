...
AgentML extensions are namespaces that add custom actions to your agents. They integrate seamlessly through the `import:prefix="uri"` directive, providing modular capabilities without modifying core SCXML functionality.
...
```xml
<agent xmlns="github.com/agentflare-ai/agentml/agent"
       import:custom="github.com/example/myextension">
...
[Learn more about Custom Extensions →](/extensions/custom)
...
|-----------|---------|--------|
| **gemini** | Google Gemini LLM integration | ✅ Stable |
| **ollama** | Local LLM via Ollama | ✅ Stable |
| **memory** | Vector search + graph database | ✅ Stable |
| **stdin** | Console I/O | ✅ Stable |
| **http** | HTTP I/O Processor | ✅ Stable |
| **websocket** | WebSocket I/O Processor | 🚧 Beta |
