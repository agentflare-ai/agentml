...
The Gemini namespace (`github.com/agentflare-ai/agentml/gemini`) integrates Google's Gemini models into AgentML agents, providing powerful cloud-based LLM capabilities.
