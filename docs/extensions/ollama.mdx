...
The Ollama namespace (`github.com/agentflare-ai/agentml/ollama`) enables AgentML agents to use locally-hosted Ollama models, providing privacy and cost-effective LLM capabilities.
