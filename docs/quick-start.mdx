...
* `version="1.0"` is the required SCXML version
...
The `<openai:generate>` action calls the Gemini LLM. Results are stored in `_event`.
...
The `schema` attribute validates incoming events against JSON Schema, ensuring data integrity.
...
Check out complete example agents in the [examples directory](https://github.com/agentflare-ai/agentml/tree/main/examples):

* **[Customer Support Bot](https://github.com/agentflare-ai/agentml/tree/main/examples/customer_support)**: Classifies and handles support requests
* **[Flight Booking Agent](https://github.com/agentflare-ai/agentml/tree/main/examples/flight_booking)**: Conversational flight booking system
* **Echo Bot**: Interactive echo agent with stdin/stdout
* **Hello World**: Simple starter agent
* **Insurance Agent**: Quote generation workflow
* **Healthcare Agent**: Healthcare marketplace agent

Find them all at [github.com/agentflare-ai/agentml/tree/main/examples](https://github.com/agentflare-ai/agentml/tree/main/examples)
