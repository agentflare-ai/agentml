...
5. **Validate responses**: Use `schema` for response validation
...
* See [Docker Deployment](/deployment/docker) or [Self-Hosted Deployment](/deployment/self-hosted) for distributed agent systems
