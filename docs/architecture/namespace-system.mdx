...
description: "Extending AgentML functionality through the namespace system with import:prefix directives"
---
...
In AgentML, namespaces extend the base SCXML vocabulary with domain-specific actions. They are declared using the `import:prefix="uri"` directive on the `<agent>` root element:

```xml
<agent xmlns="github.com/agentflare-ai/agentml/agent"
       datamodel="ecmascript"
       import:gemini="github.com/agentflare-ai/agentml/gemini"
       import:memory="github.com/agentflare-ai/agentml/memory">
...
<agent xmlns="github.com/agentflare-ai/agentml/agent"
       import:gemini="github.com/agentflare-ai/agentml/gemini"
       import:ollama="github.com/agentflare-ai/agentml/ollama"
       import:memory="github.com/agentflare-ai/agentml/memory"
       import:stdin="github.com/agentflare-ai/agentml/stdin">
```

**Official Namespace URIs:**
- `github.com/agentflare-ai/agentml/agent` - Core AgentML features (default)
- `github.com/agentflare-ai/agentml/gemini` - Google Gemini LLM integration
- `github.com/agentflare-ai/agentml/ollama` - Local LLM via Ollama
- `github.com/agentflare-ai/agentml/memory` - Vector search and graph database
- `github.com/agentflare-ai/agentml/stdin` - Console I/O
...
<agent xmlns="github.com/agentflare-ai/agentml/agent"
       ...
       import:api="./schemas/openapi.yaml">
...
**Avoid:**
```xml
import:ns1="..."  <!-- Not descriptive -->
import:XML="..."  <!-- Reserved -->
import:my-plugin="..."  <!-- Contains hyphen -->
```
...
```xml
<agent xmlns="github.com/agentflare-ai/agentml/agent"
       import:custom="github.com/example/custom">
...
```xml
<agent xmlns="github.com/agentflare-ai/agentml/agent"
       import:custom="https://cdn.example.com/custom-namespace.wasm">
