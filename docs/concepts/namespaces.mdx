---
title: "Namespaces"
description: "Extend AgentML functionality with namespaces using the import:prefix directive"
---
...
Namespaces extend the SCXML vocabulary with custom actions and elements. In AgentML, namespaces are declared using the `import:prefix="uri"` directive on the `<agent>` root element.
...
Use the `import:prefix="uri"` attribute:
